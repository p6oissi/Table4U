...
public class DataSeeder implements CommandLineRunner {
    ...
    private List<RestaurantTable> seedTables() {
        List<RestaurantTable> tables = List.of(
                // Terrace 1-4
                new RestaurantTable(1, 2, Zone.TERRACE, 0, 0, true, false, true),
                new RestaurantTable(2, 4, Zone.TERRACE, 1, 0, true, false, true),
                new RestaurantTable(3, 2, Zone.TERRACE, 2, 0, true, false, false),
                new RestaurantTable(4, 6, Zone.TERRACE, 3, 0, true, false, true),

                // Indoor 5-12
                new RestaurantTable(5, 2, Zone.INDOOR, 0, 1, true, false, true),
                new RestaurantTable(6, 4, Zone.INDOOR, 1, 1, false, false, false),
                new RestaurantTable(7, 4, Zone.INDOOR, 2, 1, false, false, true),
                new RestaurantTable(8, 6, Zone.INDOOR, 3, 1, false, false, true),
                new RestaurantTable(9, 2, Zone.INDOOR, 0, 2, true, false, false),
                new RestaurantTable(10, 8, Zone.INDOOR, 1, 2, false, false, true),
                new RestaurantTable(11, 4, Zone.INDOOR, 2, 2, false, false, true),
                new RestaurantTable(12, 2, Zone.INDOOR, 3, 2, true, false, true),

                // Private room 13-16
                new RestaurantTable(13, 4, Zone.PRIVATE_ROOM, 4, 1, true, true, false),
                new RestaurantTable(14, 10, Zone.PRIVATE_ROOM, 4, 2, true, true, false),
                new RestaurantTable(15, 8, Zone.PRIVATE_ROOM, 4, 3, true, true, false),
                new RestaurantTable(16, 6, Zone.PRIVATE_ROOM, 4, 4, true, true, false)
        );
